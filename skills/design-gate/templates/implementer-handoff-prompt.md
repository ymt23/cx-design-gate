Use the attached Project Context Packet and Visual Fidelity Contract to implement the target screen.

Do not implement from a contract that lacks an Evidence Board and Reference Decision Matrix when the request type is design_direction, reference_gate, or contract. Return `Reference research blocked` instead.
